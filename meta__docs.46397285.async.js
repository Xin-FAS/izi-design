...
}`},izid:{type:"NPM",value:"0.1.22"}},entry:"index.jsx"},context:{izid:S},renderOpts:{compile:function(){var a=P()(o()().mark(function n(){var p,t=arguments;return o()().wrap(function(i){for(;;)switch(i.prev=i.next){case 0:return i.next=2,e.e(250).then(e.bind(e,90250));case 2:return i.abrupt("return",(p=i.sent).default.apply(p,t));case 3:case"end":return i.stop()}},n)}));function d(){return a.apply(this,arguments)}return d}()}},"docs-pwd-score-demo-3":{component:l.memo(l.lazy(P()(o()().mark(function a(){var d,n,p,t,m,i,x,v,f,z,$,T;return o()().wrap(function(A){for(;;)switch(A.prev=A.next){case 0:return A.next=2,Promise.resolve().then(e.bind(e,41244));case 2:return d=A.sent,n=d.PwdScore,p=d.FAntdInput,A.next=7,Promise.resolve().then(e.t.bind(e,67294,19));case 7:return t=A.sent,m=t.useState,A.next=11,Promise.resolve().then(e.t.bind(e,21322,23));case 11:return i=A.sent,x=i.default,A.next=15,Promise.resolve().then(e.bind(e,15316));case 15:return v=A.sent,f=v.Form,z=v.Button,$=v.Input,T=v.Flex,A.abrupt("return",{default:function(){var V=m(),H=y()(V,2),ee=H[0],ae=H[1],re=m({}),ue=y()(re,2),le=ue[0],g=ue[1],j=m(""),D=y()(j,2),R=D[0],F=D[1],B=function(){ae(R?x(R).score:void 0)};return l.createElement(l.Fragment,null,l.createElement(f,{layout:"vertical",onFinish:g},l.createElement(f.Item,{name:"password",label:l.createElement(T,{align:"center"},l.createElement("span",null,"\u5BC6\u7801"),l.createElement(n,{value:ee})),rules:[{required:!0,message:"\u5BC6\u7801\u4E0D\u80FD\u4E3A\u7A7A"},function(X){var G=X.getFieldValue;return{validator:function(J,U){return!U||ee>=1?Promise.resolve():Promise.reject("\u5BC6\u7801\u5F3A\u5EA6\u592A\u5F31")}}}]},l.createElement(p.Password,{state:[R,F],onChange:B})),l.createElement(f.Item,null,l.createElement(z,{type:"primary",htmlType:"submit"},"\u63D0\u4EA4"))),"\u63D0\u4EA4\u6570\u636E\uFF1A",JSON.stringify(le))}});case 21:case"end":return A.stop()}},a)})))),asset:{type:"BLOCK",id:"docs-pwd-score-demo-3",refAtomIds:[],dependencies:{"index.jsx":{type:"FILE",value:`import { PwdScore, FAntdInput } from 'izid'
import { useState } from 'react'
